...
#ifndef INDEPENDENTARTICLEREQUEST_H
#define INDEPENDENTARTICLEREQUEST_H
...
class IndependentArticleRequest : public ArticleRequest
{
    Q_OBJECT

public:
    explicit IndependentArticleRequest(QObject *parent = 0);
...
#endif // INDEPENDENTARTICLEREQUEST_H
