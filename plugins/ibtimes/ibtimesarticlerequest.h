...
#ifndef IBTIMESARTICLEREQUEST_H
#define IBTIMESARTICLEREQUEST_H
...
class IbtimesArticleRequest : public ArticleRequest
{
    Q_OBJECT

public:
    explicit IbtimesArticleRequest(QObject *parent = 0);
