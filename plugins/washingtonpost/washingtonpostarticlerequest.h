...
#ifndef WASHINGTONPOSTARTICLEREQUEST_H
#define WASHINGTONPOSTARTICLEREQUEST_H
...
class WashingtonPostArticleRequest : public ArticleRequest
{
    Q_OBJECT

public:
    explicit WashingtonPostArticleRequest(QObject *parent = 0);
...
#endif // WASHINGTONPOSTARTICLEREQUEST_H
