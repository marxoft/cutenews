...
#ifndef TWITTERARTICLEREQUEST_H
#define TWITTERARTICLEREQUEST_H
...
class TwitterArticleRequest : public ArticleRequest
{
    Q_OBJECT

public:
    explicit TwitterArticleRequest(QObject *parent = 0);
...
private:
    ...
    void writeArticleBody(const QHtmlElement &element, bool includeImages, bool includeReplies);
    void writeTweetToArticleBody(const QHtmlElement &tweet, bool includeImages);
