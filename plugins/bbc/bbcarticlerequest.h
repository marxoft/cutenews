...
#ifndef BBCARTICLEREQUEST_H
#define BBCARTICLEREQUEST_H
...
class BbcArticleRequest : public ArticleRequest
{
    Q_OBJECT

public:
    explicit BbcArticleRequest(QObject *parent = 0);
