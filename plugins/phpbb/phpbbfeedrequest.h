...
#ifndef PHPBBFEEDREQUEST_H
#define PHPBBFEEDREQUEST_H
...
class PhpbbFeedRequest : public FeedRequest
{
    Q_OBJECT

public:
    explicit PhpbbFeedRequest(QObject *parent = 0);
