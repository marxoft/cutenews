...
#ifndef NYTIMESFEEDREQUEST_H
#define NYTIMESFEEDREQUEST_H
...
class NytimesFeedRequest : public FeedRequest
{
    Q_OBJECT

public:
    explicit NytimesFeedRequest(QObject *parent = 0);
