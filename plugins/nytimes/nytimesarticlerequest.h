...
#ifndef NYTIMESARTICLEREQUEST_H
#define NYTIMESARTICLEREQUEST_H
...
class NytimesArticleRequest : public ArticleRequest
{
    Q_OBJECT

public:
    explicit NytimesArticleRequest(QObject *parent = 0);
