...
#ifndef POLITICOARTICLEREQUEST_H
#define POLITICOARTICLEREQUEST_H
...
class PoliticoArticleRequest : public ArticleRequest
{
    Q_OBJECT

public:
    explicit PoliticoArticleRequest(QObject *parent = 0);
...
#endif // POLITICOARTICLEREQUEST_H
