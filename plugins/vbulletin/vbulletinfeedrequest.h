...
#ifndef VBULLETINFEEDREQUEST_H
#define VBULLETINFEEDREQUEST_H
...
class VbulletinFeedRequest : public FeedRequest
{
    Q_OBJECT

public:
    explicit VbulletinFeedRequest(QObject *parent = 0);
