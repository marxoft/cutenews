...
#ifndef MYBBFEEDREQUEST_H
#define MYBBFEEDREQUEST_H
...
class MybbFeedRequest : public FeedRequest
{
    Q_OBJECT

public:
    explicit MybbFeedRequest(QObject *parent = 0);
