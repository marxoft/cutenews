...
#ifndef WORDPRESSFEEDREQUEST_H
#define WORDPRESSFEEDREQUEST_H
...
class WordpressFeedRequest : public FeedRequest
{
    Q_OBJECT

public:
    explicit WordpressFeedRequest(QObject *parent = 0);
...
private:
    ...
    void writeStartFeed();
    void writeEndFeed();
    void writeFeedTitle(const QHtmlElement &element);
    ...
    QStringList m_articleUrls;
    QVariantMap m_settings;
};

#endif // WORDPRESSFEEDREQUEST_H
