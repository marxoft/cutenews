...
// Plugins
static const QStringList PLUGIN_PATHS = QStringList() << QString("/usr/share/cutenews/plugins/")
...
// Icons
static const QString DEFAULT_ICON("/usr/share/cutenews/icons/cutenews.png");
