...
Dialog {
    ...
    property bool highlightSelectedIndex: true
    ...
    Component {
        ...
        MenuItem {
            text: (root.selectedIndex === index) && (root.highlightSelectedIndex) ? "<p style='color: " + platformStyle.colorNormalLink + "'>" + name + "</p>" : name
            onClicked: {
