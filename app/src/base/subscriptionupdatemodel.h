...
#ifndef SUBSCRIPTIONUPDATEMODEL_H
#define SUBSCRIPTIONUPDATEMODEL_H
...
class SubscriptionUpdateModel : public QAbstractListModel
{
    Q_OBJECT
...
public:
    ...
    explicit SubscriptionUpdateModel(QObject *parent = 0);
...
#endif // SUBSCRIPTIONUPDATEMODEL_H
