...
#ifndef JAVASCRIPTENCLOSUREREQUESTGLOBALOBJECT_H
#define JAVASCRIPTENCLOSUREREQUESTGLOBALOBJECT_H
...
class JavaScriptEnclosureRequestGlobalObject : public QObject
{
    Q_OBJECT
...
#endif // JAVASCRIPTENCLOSUREREQUESTGLOBALOBJECT_H
