...
ApplicationWindow {
    ...
    || (subscriptionModel.status == SubscriptionModel.Active)
    menuBar: MenuBar {
        MenuItem {
            action: reloadAction
        }
    ...
    Action {
        ...
        onTriggered: {
            ...
            case Subscription.Plugin:
                ...
                break;
            default:
                popupManager.open(Qt.resolvedUrl("SubscriptionDialog.qml"), appWindow, {subscriptionId: subscription.id,
    ...
    Connections {
        ...
        onServerAddressChanged: {
            ...
            importAction.enabled = connected;
            searchAction.enabled = connected;
            transfersAction.enabled = connected;
            subscriptionButton.enabled = connected;
